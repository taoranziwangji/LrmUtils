...
/**
 * 废弃，被TimeChangeUtil功能锁代替
 *
 * 时间计算工具类
 * 主要计算两个时间(new TimeUtilCalculate())的时间和/差
 *
 */
@Deprecated
public class TimeUtilCalculate {
     ...
     * @param minute    分钟
     */
    public TimeUtilCalculate(int hour, int minute) {
     ...
     * @param second    秒
     */
    public TimeUtilCalculate(int hour, int minute, int second) {
     ...
     */
    public TimeUtilCalculate(String time) {
        this(time, null);
    }
     ...
     * @param second    秒
     */
    public TimeUtilCalculate(int day, int hour, int minute, int second) {
     ...
     * @param time      字符串格式的时间
     */
    public TimeUtilCalculate(String time, String timeSeparator) {
     ...
     * @return          运算后的时间
     */
    public TimeUtilCalculate addTime(TimeUtilCalculate time) {
        TimeUtilCalculate result = new TimeUtilCalculate();
        int up = 0;     // 进位标志
     ...
     * @return          运算后的时间
     */
    public TimeUtilCalculate subtractTime(TimeUtilCalculate time) {
        TimeUtilCalculate result = new TimeUtilCalculate();
        int down = 0;       // 退位标志
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final TimeUtilCalculate other = (TimeUtilCalculate) obj;
