...
public class HtmlTextView extends JellyBeanSpanFixTextView {
     ...
     */
    public void setHtmlFromRawResource(Context context, int id, boolean useLocalDrawables,final zoom z) {
        // load html from html file from /res/raw
        InputStream inputStreamText = context.getResources().openRawResource(id);

        setHtmlFromString(convertStreamToString(inputStreamText), useLocalDrawables,z);
    }
     ...
     */
    public void setHtmlFromString(String html, boolean useLocalDrawables,final zoom z) {
        ...
        if (useLocalDrawables) {
            ...
            imgGetter = new UrlImageGetter(this, getContext()){
				...
				public Drawable zoomDrawable(Drawable drawable) {
					...
					return z.zoomDrawable(drawable);
				}
