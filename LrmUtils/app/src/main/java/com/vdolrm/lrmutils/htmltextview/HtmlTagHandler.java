...
public class HtmlTagHandler implements Html.TagHandler {
    ...
    public void handleTag(final boolean opening, final String tag, Editable output, final XMLReader xmlReader) {
        if (opening) {
            ...
            if (HtmlTextView.DEBUG) {
                MyLog.d(HtmlTextView.TAG, "opening, output: " + output.toString());
            }
            ...
            // closing tag
            if (HtmlTextView.DEBUG) {
                MyLog.d(HtmlTextView.TAG, "closing, output: " + output.toString());
            }
    ...
    private void start(Editable output, Object mark) {
        ...
        if (HtmlTextView.DEBUG) {
            MyLog.d(HtmlTextView.TAG, "len: " + len);
        }
    }
    ...
    private void end(Editable output, Class kind, Object repl, boolean paragraphStyle) {
        ...
        if (HtmlTextView.DEBUG) {
            MyLog.d(HtmlTextView.TAG, "where: " + where);
            MyLog.d(HtmlTextView.TAG, "len: " + len);
        }
    }
