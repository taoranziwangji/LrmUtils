...
/**下拉时头部图像的阻尼效果，类似原微信朋友圈*/
public class vdoStickyLayout extends LinearLayout {
    ...
    public vdoStickyLayout(Context context) {
        super(context);
    }

    public vdoStickyLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public vdoStickyLayout(Context context, AttributeSet attrs, int defStyle) {
